...
const AUDIO_DATABASE = {
  ...
  "041187": { // КРИТИЧЕСКИЙ СЮЖЕТНЫЙ ЗВОНОК (РАЗОБЛАЧЕНИЕ АЛИБИ)
    ...
    isCritical: true,
    transcript: [
      { speaker: "Маркус", text: "Селена, это Маркус. Снова" },
      { speaker: "Маркус", text: "Прекрати игнорировать мои звонки. Это непрофессионально. И это оскорбительно. Я видел тебя вчера с ним, с этим..." },
      { speaker: "Маркус", text: "Мальчиком" },
      { speaker: "Маркус", text: "Ты действительно думаешь, что он может дать тебе то, что дал я? Я тебя создал." },
      { speaker: "Маркус", text: "Я вытащил тебя из той дыры, Это была инвестиция. Я привык получать отдачу от своих инвестиций." },
      { speaker: "Маркус", text: "Я сегодня буду рядом с твоей студией. Нам нужно поговорить. И мы поговорим. Конец связи." },
    ]
  },
  "774102": {
    caller: "Маркус Флинн",
  ...
  "069201": { // КРИТИЧЕСКИЙ СЮЖЕТНЫЙ ЗВОНОК (ОЦЕНКА КАРТИН ДЛЯ СТРАХОВКИ)
    ...
    isCritical: true,
    transcript: [
      { speaker: "Веспер", text: "ААларик, Аларик, это Веспер. Возьми трубку, чёрт возьми. " },
      { speaker: "Веспер", text: "Ты слышал? Ты видел новости? Это Селена." },
      { speaker: "Веспер", text: "Её… Её нашли… в студии… мёртвой. О боже, Аларик, что нам делать? Полиция… Они будут говорить со всеми… Они будут говорить с нами… Конкурс… И… И наша сделка в тот вечер… Они всё раскопают… " },
      { speaker: "Веспер", text: "Нам нужно поговорить… Немедленно… Нам нужно, чтобы наши истории соспадали… Позвони мне… Как только получишь это… Позвони…" },
    ]
  },
  "881204": {
    caller: "Веспер Уэйнрайт",
  ...
  "021998": { // КРИТИЧЕСКИЙ СЮЖЕТНЫЙ ЗВОНОК (СГОВОР МАТЕРИ И СЫНА)
    ...
    isCritical: true,
    transcript: [
      { speaker: "Розалия", text: "Эван, дорогой, это мама, я звоню, чтобы убедиться, что у тебя всё в порядке. " },
      { speaker: "Розалия", text: "Ты казался рассеянным сегодня утром." },
      { speaker: "Розалия", text: "Я надеюсь, эта… ситуация с Селиной не выбивает тебя из колеи? Помни, что бы ни случилось, семья всегда на первом месте." },
      { speaker: "Розалия", text: "Мы решим любые проблемы. Вместе, как всегда.  Жду тебя к ужину в семь." },
      { speaker: "Розалия", text: "Не опаздывай!" }
    ]
  },
  "115623": {
    caller: "Розалия Андервуд",
