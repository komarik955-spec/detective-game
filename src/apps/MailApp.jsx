...
И помните: правда редко лежит на поверхности.`,
...

  {
    ...
    preview: 'Детектив, направляю вам скан предварительного рапорта о происшествии по делу №0078...',
    date: '09:13',
    body: `Детектив,

Направляю вам скан предварительного рапорта о происшествии по делу №0078 для ознакомления.
